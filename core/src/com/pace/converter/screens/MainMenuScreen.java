...
import com.pace.converter.enums.TextFieldEnum;
...
public class MainMenuScreen implements Screen{
	...
	private ShapeRenderer srOnglet1;
	...
	public MainMenuScreen(final MyGdxGame gam) {
		...
		labelSpeedTitre.setY(image1.getY() + 3*image1.getHeight()/4 - labelSpeedTitre.getHeight()/2);
		labelSpeedTitre.setX(image1.getX() + image1.getWidth()/2 - labelSpeedTitre.getWidth()/2);
		labelPaceTitre = new Label(stringPace, labelStyleTitre);
		labelPaceTitre.setY(image2.getY() + 3*image2.getHeight()/4 - labelPaceTitre.getHeight()/2);
		labelPaceTitre.setX(image2.getX() + image2.getWidth()/2 - labelPaceTitre.getWidth()/2);
		...
		tableSpeed.setX((tableSpeed.getPrefWidth()/2 - Gdx.graphics.getWidth()/2) + image1.getX() + image1.getWidth()/2 - tableSpeed.getPrefWidth()/2);
		tableSpeed.setY((tableSpeed.getPrefHeight()/2 - Gdx.graphics.getHeight()/2) + image1.getY() + image1.getHeight()/4 - 0.5f*tableSpeed.getPrefHeight());
		...
		tablePace.setX((tablePace.getPrefWidth()/2 - Gdx.graphics.getWidth()/2) + image2.getX() + image2.getWidth()/2 - tablePace.getPrefWidth()/2);
	...
	public void render(float delta) {
		...
		srOnglet1.rect(Variables.ONGLET_X2, ONGLET_Y, 2 * Variables.ONGLET_WIDTH, ONGLET_HEIGHT);
		srOnglet1.end();
