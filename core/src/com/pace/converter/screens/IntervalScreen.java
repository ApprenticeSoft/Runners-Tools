...
public class IntervalScreen implements Screen{
	...
	private ShapeRenderer srOnglet1, srEchauffement, srEffort, srRepos, srCycle;
	...
	public IntervalScreen(final MyGdxGame gam){
		...
		//labelStyleCalorie = new LabelStyle(game.fontCalorie, Color.WHITE);
		...
		srEchauffement = new ShapeRenderer();
		srEffort = new ShapeRenderer();
		srRepos = new ShapeRenderer();
		srCycle = new ShapeRenderer();
		/***********************************************************************************/
	...
	public void render(float delta) {
		...
		srOnglet1.setColor(r2, g2, b2, 1);
		srOnglet1.rect(Variables.ONGLET_X1, ONGLET_Y, 2*Variables.ONGLET_WIDTH, ONGLET_HEIGHT);
		srOnglet1.end();
		srEchauffement.begin(ShapeType.Filled);
		srEchauffement.setColor(1, 1, 1, 0);
		srEchauffement.rect(shapeRendererX, shapeRendererY1, shapeRendererWidth, shapeRendererHeight);
		srEchauffement.end();
		srEffort.begin(ShapeType.Filled);
		srEffort.setColor(1, 1, 1, 0);
		srEffort.rect(shapeRendererX, shapeRendererY2, shapeRendererWidth, shapeRendererHeight);
		srEffort.end();
		srRepos.begin(ShapeType.Filled);
		srRepos.setColor(1, 1, 1, 0);
		srRepos.rect(shapeRendererX, shapeRendererY3, shapeRendererWidth, shapeRendererHeight);
		srRepos.end();
		srCycle.begin(ShapeType.Filled);
		srCycle.setColor(1, 1, 1, 0);
		srCycle.rect(shapeRendererX, shapeRendererY4, shapeRendererWidth, shapeRendererHeight);
		srCycle.end();
